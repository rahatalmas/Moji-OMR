...
class _CandidateEditor extends State<CandidateEditor> {
  ...
  void _addCandidate() async {
    ...
    if (res) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('failed to add candidate'),
        ),
      );
    }
    ...
    return ListView(
      children: [
        ...
        examProvider.selectedExam == null
            ...
            : examProvider.selectedExam!.numberOfCandidates ==
                    candidateProvider.candidates.length
                ? Center(
                    child: Column(
                    mainAxisSize: MainAxisSize.min,
                    children: [
                      ...
                      Text(
                        'Total Candidates: ${examProvider.selectedExam!.totalQuestions}',
                      ),
                      const Text('Exam Date: 20/12/24')
                    ],
                  ))
                : Container(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Padding(
                            ...
                            child: candidateProvider.candidates.isNotEmpty
                                ? Column(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                          'last Added: ${candidateProvider.candidates[candidateProvider.candidates.length - 1].serialNumber}'),
                                    ],
                                  )
                                : const Center(
