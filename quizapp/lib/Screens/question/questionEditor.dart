...
class _QuestionEditor extends State<QuestionEditor> {
  ...
  void _setTotalAndOptions() {
    ...
    bool isReset = Provider.of<QuestionProvider>(context, listen: false)
        .questions
        .isNotEmpty;
              ...
              return Column(
                ...
                children: [
                  ...
                  TextField(
                    ...
                    decoration:
                    InputDecoration(labelText: "Options per Question"),
                    keyboardType: TextInputType.number,
                  ),
                  if (showError) ...[
                    SizedBox(height: 10),
            ...
            if (isReset) ...[
              TextButton(
                onPressed: () {
                  ...
                  setState(() {
                    totalQuestions =
                        int.tryParse(totalQuestionsController.text) ?? 10;
                    ...
                    if (parsedOptions != null &&
                      ...
                      errorMessage =
                      'Please enter a valid number of options (2-6).';
                    }
                  });
                },
                child: Text("Reset"),
            ...
            TextButton(
              onPressed: () {
                ...
                if (Provider.of<QuestionProvider>(context, listen: false)
                  ...
                  showError = true;
                  errorMessage =
                  'To change options, please reset the added questions.';
                } else if (totalQuestionsController.text.isNotEmpty &&
                  ...
                  showError = true;
                  errorMessage =
                  'You cannot decrease the total number of questions after adding them.';
                      ...
                      TextField(
                        ...
                        decoration: InputDecoration(
                          ...
                          prefixIcon: Icon(Icons.question_mark,
                              size: 10, color: Colors.brown[800]),
